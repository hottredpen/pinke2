...
class Model {
     ...
     */
     protected function _facade($data) {
        ...
        // 过滤属性
        if(!empty($this->not_allow_field)){
            $not_allow_field_arr  = array_filter(explode(",", $this->not_allow_field));
            foreach ($not_allow_field_arr as  $_not_allow_field) {
                unset($data[$_not_allow_field]);
            }
        }
     ...
     */
     public function create($data='',$type='') {
        ...
        if(!$this->beforeAutoValidation($data,$type)) return false;
    ...
    protected function beforeAutoValidation($data,$type){
        return true;
    }
    ...
    /**
     * 过滤不允许提交操作的字段
     * @param  string $not_allow_field [description]
     * @return [type]                  [description]
     */
    public function not_allow_field($not_allow_field=""){
        $this->not_allow_field = $not_allow_field;
        return $this;
    }
