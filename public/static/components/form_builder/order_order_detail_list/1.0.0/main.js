...
var component = {
	getName : function(){
		return "order_order_detail_list@1.0.0";
	},
	getAuthKey : function(){
		return "6364d3f0f495b6ab9dcf-9ac05befca7d64a9e3ab-b4b147bc522828731f1a-ba270a3667ac47be61db386be56e7f3e"; // 检测是授权组件
	},
	createObj : function(){
		var obj = {};
		...
		function enter_html_append(_val){
    		$(".j_append_choose_product").append("<tr class='j_product_item_id j_product_item_id_"+_val.id+"'>\
    			...
    			<td class='text-center'><input name='enter_num_of_piece[]' value='"+_val.num_of_piece+"'></td>\
