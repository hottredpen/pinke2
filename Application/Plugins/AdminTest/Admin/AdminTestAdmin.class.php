...
class AdminTestAdmin extends AdminTestBaseAdmin {
    ...
    public function admin_test_list(){
        ...
        $builder->theme('one')->setMetaTitle('测试列表')
                ...
                ->addTableColumn('scence_id', 'scence_id')
    ...
    public function addAdminTest(){
        ...
        $scence_id    = I('scence_id',11,'intval');
        ...
        $formPostItems  = $modelTest->formPostItems($scence_id,$group_id);
        ...
        $info['_pk_scence_id']       = $scence_id;
        $info['_pk_group_id']       = $group_id;
        $info['_pk_handle_object']  = $modelTest->getHandleObject();
        $info['_pk_handle_action']  = $modelTest->getHandleAction($scence_id);
        ...
        $builder->theme('one')->setMetaTitle('调整测试数据')
                ...
                ->addFormItem("_pk_scence_id",'hidden')
    ...
    public function startAdminTest(){
        ...
        $test_data  = $modelTest->getUnitTestData($scence_id,$group_id,$id);
